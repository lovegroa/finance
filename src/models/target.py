...
class Target(object):
    def __init__(self, user_id, target_date, created_date=datetime.utcnow(), amount=0, _id=None):
    ...
    @staticmethod
    def find_targets(id):
        return [target for target in Database.find(collection='targets', query={'user_id': id}, sort='target_date')]
