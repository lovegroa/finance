...
class NExpense(object):
    def __init__(self, user_id, name, account_id, start_date, end_date, paid_dates, frequency, created_date=datetime.utcnow(),amount=0, debit=1, _id=None):
    ...
    def update_mongo(self):
        Database.update(collection='nexpenses', query={'_id': self._id}, data=self.json())
    ...
    def find_nexpenses(id):
        return [expense for expense in Database.find(collection='nexpenses', query={'user_id': id}, sort='start_date')]
